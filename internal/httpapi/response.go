...
func writeErr(w http.ResponseWriter, err error) {
	...
	case model.ErrConflict, model.ErrStateMachine, model.ErrEventClosed, model.ErrDropletIDDuplicate:
		code = http.StatusConflict
	case model.ErrInvalid, model.ErrSequenceRegression, model.ErrCoordOutOfRange,
		model.ErrNoFrozenVersion, model.ErrFrozen:
